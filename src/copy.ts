...
export const HERO_INTRO =
  '先选规划师（方面陈爆款 / 港险 / 通用），再选场景或快捷能力。需要时可开联网查资料；方面陈模式可叠方法论知识库。登录或填入助理下发的 Key 后可同步云端人设。'
...
简单代码相关
可帮你梳理解读一小段代码思路、步骤与注意点（复杂工程仍以专业开发为准）。

联网查资料
打开「联网搜索」并写好检索词后，会按关键词上网汇总参考；写热点类内容时，尽量写清热点名称，并优先用「热点解读」入口，结果更贴题。

人设与多设备
登录后可在不同设备间同步你的「人设卡片」。若助理已为你开通专属 Key，也可不登录、用 Key 使用同款人设。页面里的「个人补充」仍可随时写几句自己的习惯用语（仅本机）。

方面陈知识库 vs 演示口吻
「方面陈知识库」侧重方法论与结构；「方面陈演示口吻」是单独开关，打开后更接近港式口播示例语气。

创作阶段
在高级设置里可选「收集需求 / 方向建议 / 成稿」等，让输出更按步骤来。
