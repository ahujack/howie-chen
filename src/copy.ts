...
export const HERO_INTRO =
  '我可以结合联网检索（可选）协助你：短视频选题与脚本、开头优化、账号诊断、朋友圈文案等；默认叠加「方面陈 · 内容创作知识库」（人设/禁忌/结构，与 OpenClaw Skill 同源），可在下方关闭以省上下文。方法论同时锚定陈科豪体系。'
...
方面陈知识库
勾选「方面陈知识库」时，会把《方面陈内容创作知识库》全文注入系统提示（人设锚点、9-1 法则、口播节奏、禁区、选题与爆款案例等）；关闭后仅保留陈科豪体系通用能力。
